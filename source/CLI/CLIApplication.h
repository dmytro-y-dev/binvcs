...
#ifndef METAMAKER_BINVCS_CLI_CLIAPPLICATION
#define METAMAKER_BINVCS_CLI_CLIAPPLICATION
...
namespace binvcs_cli
{
	...
	public:
		...
		void Start(string commandLineText);

	};

}

#endif //METAMAKER_BINVCS_CLI_CLIAPPLICATION
