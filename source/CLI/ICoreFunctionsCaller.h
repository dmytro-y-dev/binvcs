...
#ifndef METAMAKER_BINVCS_CLI_ICOREFUNCTIONSCALLER
#define METAMAKER_BINVCS_CLI_ICOREFUNCTIONSCALLER

namespace binvcs_cli
{
	class ICoreFunctionsCaller
	{

	public:
		ICoreFunctionsCaller();
		virtual ~ICoreFunctionsCaller();
...
#endif //METAMAKER_BINVCS_CLI_ICOREFUNCTIONSCALLER
