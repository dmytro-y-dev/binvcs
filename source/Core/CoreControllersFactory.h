...
#ifndef METAMAKER_BINVCS_CORE_CORECONTROLLERSFACTORY
#define METAMAKER_BINVCS_CORE_CORECONTROLLERSFACTORY

namespace binvcs_core
{
	class CoreControllersFactory
	{
	...
	public:
		...
		RepositoryStatusControllerPtr GetRepositoryStatusController();
		StageControllerPtr GetStageController();

	private:
		RepositoryFactoryPtr GetRepositoryFactory();

	};

}

#endif //METAMAKER_BINVCS_CORE_CORECONTROLLERSFACTORY
