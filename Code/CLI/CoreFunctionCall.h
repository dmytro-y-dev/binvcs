...
#ifndef METAMAKER_BINVCS_CLI_COREFUNCTIONCALL
#define METAMAKER_BINVCS_CLI_COREFUNCTIONCALL

namespace binvcs_cli
{
	/**
	 * CoreFunctionCall is a pointer to DefaultCoreFunctionsCaller method.
	 */

}

#endif //METAMAKER_BINVCS_CLI_COREFUNCTIONCALL
